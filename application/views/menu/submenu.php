...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newSubMenuModal">Add New Submenu <i class="fas fa-fw fa-plus fa-sm"></i></a>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('menu/deleteSubmenu/') ?><?= $sm['id']; ?>" class="badge badge-danger" onclick="return confirm('Are you sure to delete it?')" id="delete" name="delete"><i class="fas fa-fw fa-trash-alt fa-sm"></i> Delete</a>
                            </td>
                        </tr>
                        <?php $i++ ?>
                    <?php endforeach; ?>
...
<?php foreach ($subMenu as $sm) : ?>
    <div class="modal fade" id="modalEdit<?= $sm['id'] ?>">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="<?= base_url('menu/editsubmenu'); ?>" method="post">
                    ...
                    <input type="hidden" readonly value="<?= $sm['id']; ?>" name="submenu_id" class="form-control">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary"><i class="fa fa-fw fa-pencil-alt fa-sm"></i> Edit</button>
                    </div>
                </form>
            </div>
        </div>
